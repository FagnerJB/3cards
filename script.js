class Game {
  ...
  setFace(element, arrayImg){
    ...
    element.querySelector('.face').style.backgroundImage = `url('https://ul.fagnerjb.com/telo/${face}.jpg')`

  }

  clicked(){

    if( document.body.classList.contains('unclickable') )
      return
  ...
  constructor(){
    ...
    button.innerText = (attempts == 1) ? attempts + ' tentativa' : attempts + ' tentativas'
...
const button = document.querySelector('#start'),
    sameTelo = ['micheltelo - 6Sr_ypRyB4', 'micheltelo - BISWKAvA_EW', 'micheltelo - v9TQ6wRyMS'],
    diffTelo = ['micheltelo - BcVuYAwhq6Q', 'micheltelo - nUJ0dBxyM4', 'micheltelo - m26p8'],
    results  = ['filipedeschamps - B0KI5l8g34e', 'filipedeschamps - thumb', 'dieegosf - BGEpMUrHnCt']
let attempts = 3
...
function preload(image){
  ...
  preloadLink.href = `https://ul.fagnerjb.com/telo/${image}.jpg`
